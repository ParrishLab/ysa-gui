...
class MainWindow(QMainWindow):
    ...
    def on_analysis_completed(self):
        self.analysis_manager.on_analysis_completed()

    def cancel_analysis(self):
        self.analysis_manager.cancel_analysis()

    def find_discharges(self):
        self.analysis_manager.find_discharges()

    def auto_analyze(self):
        self.analysis_manager.auto_analyze()

    def edit_raster_settings(self):
        self.analysis_manager.edit_raster_settings()

    def skipBackward(self):
        self.playback_manager.skip_backward()

    def stepBackward(self):
        self.playback_manager.step_backward()

    def playPause(self):
        self.playback_manager.play_pause()

    def updatePlayback(self):
        self.playback_manager.update_playback()

    def stepForward(self):
        self.playback_manager.step_forward()

    def skipForward(self):
        self.playback_manager.skip_forward()

    def setPlaybackSpeed(self, index):
        self.playback_manager.set_playback_speed(index)

    def seekPosition(self, value):
        self.playback_manager.seek_position(value)

    def lock_plots_to_playhead(self):
        self.playback_manager.lock_plots_to_playhead()

    def get_channels(self):
        return self.data_manager.get_channels()

    def create_grid(self):
        self.data_manager.create_grid()

    def get_min_max_strengths(self):
        self.data_manager.get_min_max_strengths()

    def normalize_strength(self, strength):
        return self.data_manager.normalize_strength(strength)

    def get_seizure_strength(self, row, col):
        return self.data_manager.get_seizure_strength(row, col)

    def clear_found_discharges(self):
        self.data_manager.clear_found_discharges()

    def load_discharges(self):
        self.data_manager.load_discharges()

    def export_discharge_stats(self):
        self.data_manager.export_discharge_stats()
    ...
    def draw_spread_arrows(self, row, col, event_type):
        self.visualization_manager.draw_spread_arrows(row, col, event_type)
    ...
    def blend_colors(self, color1, color2, strength):
        return self.visualization_manager.blend_colors(color1, color2, strength)

    def on_cell_clicked(self, row, col):
        self.event_handler.handle_cell_click(row, col)

    def handle_region_clicked(self, start, stop):
        self.event_handler.handle_region_click(start, stop)

    # Wrapper methods for compatibility
    def _channel_extract(self):
        return ChannelExtract(self).exec_()

    def _save_grid_dialog(self):
        return open_save_grid_dialog(self)

    def _save_mea_with_plots(self):
        return save_mea_with_plots(self)
